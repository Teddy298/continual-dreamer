...
config = dv2.defaults.update({
    'logdir': '/net/tscratch/people/plgtaddziarm/logdir/27.11/simple15_nonuni_over_policy',
    'log_every': 1e3,
    'train_every': 10,
    'prefill': 1e4,
    'actor_ent': 3e-3,
...
wandb.init(
            project="dreamer_oversampling_policy_test",
            name="simple15_nonuni",
            config=config,
            reinit=True,
            resume=False,
...
class SimpleCrossingEnv(CrossingEnv):
    def __init__(self):
        super().__init__(size=15, num_crossings=1, obstacle_type=Wall)

env2 = SimpleCrossingEnv()
